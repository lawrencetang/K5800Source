/********************************************************************************
** Form generated from reading UI file 'ccdialog.ui'
**
...
#ifndef UI_CCDIALOG_H
#define UI_CCDIALOG_H
...
public:
    ...
    void setupUi(QDialog *CcDialog)
    {
        if (CcDialog->objectName().isEmpty())
            CcDialog->setObjectName(QStringLiteral("CcDialog"));
        CcDialog->resize(496, 167);
        CcDialog->setStyleSheet(QString::fromUtf8("QLabel,QSpinBox,QDoubleSpinBox,QPushButton,QLineEdit,QComboBox{\n"
"	min-height:48px;\n"
...
"    height: 49px;   \n"
"}"));
        horizontalLayout_6 = new QHBoxLayout(CcDialog);
        horizontalLayout_6->setObjectName(QStringLiteral("horizontalLayout_6"));
        groupBox = new QGroupBox(CcDialog);
        ...
        retranslateUi(CcDialog);

        QMetaObject::connectSlotsByName(CcDialog);
    } // setupUi

    void retranslateUi(QDialog *CcDialog)
    {
        CcDialog->setWindowTitle(QApplication::translate("CcDialog", "Cell Culture", 0));
        groupBox->setTitle(QApplication::translate("CcDialog", "Method", 0));
        typeLabel->setText(QApplication::translate("CcDialog", "Type", 0));
        waveLabel->setText(QApplication::translate("CcDialog", "Wave", 0));
        waveSpinBox->setSuffix(QApplication::translate("CcDialog", " nm", 0));
        cancelPBtn->setText(QApplication::translate("CcDialog", "Cancel", 0));
        okPBtn->setText(QApplication::translate("CcDialog", "OK", 0));
    } // retranslateUi

};

namespace Ui {
    class CcDialog: public Ui_CcDialog {};
} // namespace Ui
