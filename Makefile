#############################################################################
# Makefile for building: BioFuture_A
# Generated by qmake (3.0) (Qt 5.4.2)
# Project:  BioFuture_A.pro
# Template: app
# Command: C:\Qt\Qt5.4.2\5.4\mingw491_32\bin\qmake.exe -spec win32-g++ CONFIG+=debug -o Makefile BioFuture_A.pro
#############################################################################
...
Makefile: BioFuture_A.pro C:/Qt/Qt5.4.2/5.4/mingw491_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.4.2/5.4/mingw491_32/mkspecs/features/spec_pre.prf \
		...
		DataView/DataView.pri \
		CameraView/CameraView.pri \
		OligoCalculator/OligoCalculator.pri \
		RecordView/RecordView.pri \
		FittingView/FittingView.pri \
		PlotView/PlotView.pri \
		SettingsView/SettingsView.pri \
		ToolsView/ToolsView.pri \
		TempControlView/TempControlView.pri \
		CheckView/CheckView.pri \
		DataModel/DataModel.pri \
		Controller/Controller.pri \
		Logger/Logger.pri \
		Accredit/accredit.pri \
		Spectrograph/Spectrograph.pri \
		...
		C:/Qt/Qt5.4.2/5.4/mingw491_32/lib/Qt5MultimediaWidgets.prl \
		C:/Qt/Qt5.4.2/5.4/mingw491_32/lib/Qt5Svg.prl \
		C:/Qt/Qt5.4.2/5.4/mingw491_32/lib/Qt5Widgets.prl \
		C:/Qt/Qt5.4.2/5.4/mingw491_32/lib/Qt5Multimedia.prl \
	...
	$(QMAKE) -spec win32-g++ CONFIG+=debug -o Makefile BioFuture_A.pro
